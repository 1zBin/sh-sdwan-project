          ...
          <template #actions>
            <template v-if="item.key === 'contentWidth'">
              <a-select
                ...
                @update:value="(e:any) => handleChangeSetting('contentWidth', e)"
              >
            ...
            <template v-if="item.key === 'fixedHeader'">
              <a-switch
                ...
                :checked="fixedHeader"
                :disabled="item.disabled"
                @update:checked="(e:any) => handleChangeSetting('fixedHeader', e)"
              />
            </template>
            <template v-if="item.key === 'fixSiderbar'">
              <a-switch
                ...
                :checked="fixedSider"
                :disabled="item.disabled"
                @update:checked="(e:any) => handleChangeSetting('fixedSider', e)"
              />
            </template>
            <template v-if="item.key === 'splitMenus'">
              <a-switch
                ...
                :checked="splitMenus"
                :disabled="item.disabled"
                @update:checked="(e:any) => handleChangeSetting('splitMenus', e)"
              />
            </template>
          </template>
